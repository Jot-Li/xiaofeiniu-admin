...
export default new Vuex.Store({
    //公共数据读取方法(只能读，不能修改)：this.$store.state.adminName
    //公共数据读取方法(只能读，不能修改)：this.$store.state.globalSettings
    ...
    mutations: {   //控制数据的进化(即修改state)，
    //类似于组件对象中的methods——用mutations修改数据可以保证数据的“响应式”
